...
交付计划共 416 只基础母羊，分八批滚动配种，日峰值恰为 112 栏，年化出栏 1326.11 只/年 [[EV.plan_replay]]。
...
栏位缺口区间为 10 至 16 栏，受限类缺口下界为 11 栏 [[EV.gap_witness]]。
...
报告集 n=200 的头条产出为 962.48 只/年，选型集头条为 950.35 只/年，出栏配对差为 -3.49 只，随机模拟方法见文献[2] [[EV.q3_report]]。
